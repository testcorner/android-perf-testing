...
public class Settings {
    ...
    public void setUp() {
        ...
        mDevice.wait(Until.hasObject(By.res("com.skysoft.kkbox.android:id/layout_runway")), LAUNCH_TIMEOUT);
    }
    ...
    public void turnPage() {
        ...
        mDevice.waitForIdle();
        mDevice.wait(Until.findObject(By.desc("設定")), LAUNCH_TIMEOUT).click();

        mMeasureExecutionTime.begin();

        mDevice.wait(Until.findObject(By.text("設定")), LAUNCH_TIMEOUT);
